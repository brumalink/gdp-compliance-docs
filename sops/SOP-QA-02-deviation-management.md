# SOP-QA-02 Deviation management
...
Ensure that every departure from GDP requirements is recorded, assessed and, where needed, corrected.

## 2. Procedure

1. Anyone who notices a deviation opens a record in the [deviation register](../registers/deviation-register.csv)
